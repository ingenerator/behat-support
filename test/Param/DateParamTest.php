...
class DateParamTest extends TestCase
{
    ...
    #[TestWith(['2017-03-18', 'Y-05-d', '2017-05-18 00:00:00'])]
    #[TestWith(['2017-03-18', '2019-m-d', '2019-03-18 00:00:00'])]
    #[TestWith(['2017-03-18', '2019-05-07', '2019-05-07 00:00:00'])]
    ...
    #[TestWith(['2017-04-18', 'Y-m-(d-3)', '2017-04-15 00:00:00'])]
    #[TestWith(['2017-03-02', 'Y-m-(d-5)', '2017-02-25 00:00:00'])]
    #[TestWith(['2017-03-02', 'Y-(m+1)-d', '2017-04-02 00:00:00'])]
    #[TestWith(['2017-03-02', 'Y-(m-2)-d', '2017-01-02 00:00:00'])]
    #[TestWith(['2017-03-02', 'Y-(m-5)-d', '2016-10-02 00:00:00'])]
    #[TestWith(['2017-03-02', '(Y-2)-(m+1)-d', '2015-04-02 00:00:00'])]
    #[TestWith(['2017-03-02', '(Y+3)-(m-2)-d', '2020-01-02 00:00:00'])]
    #[TestWith(['2017-03-02', '(Y-1)-(m-5)-d', '2015-10-02 00:00:00'])]
    ...
    #[TestWith(['2017-04-18', '(Y+1)-m-03', '2018-04-03 00:00:00'])]
    #[TestWith(['2017-04-18', 'Y-03-(d+15)', '2017-04-02 00:00:00'])]
    #[TestWith(['2017-11-18', '2018-(m+2)-d', '2019-01-18 00:00:00'])]
