...
class ScenarioPlaceholderArgumentTransformerTest extends TestCase
{
    ...
    public static function provider_expected_type_support()
    {
        return [
            'string'     => ['foo', TRUE],
    ...
    #[TestWith(['John and {{reverse:Bill}}', 'John and lliB'])]
    #[TestWith(['John, {{reverse:Bill}}, and Peter', 'John, lliB, and Peter'])]
    ...
    public static function provider_parse_tables()
    {
        return [
            'one cell'             => [
    ...
    public static function provider_parse_pystrings()
    {
        return [
            'one replacement'       => [
    ...
    public static function provider_unchanged()
    {
        return [
